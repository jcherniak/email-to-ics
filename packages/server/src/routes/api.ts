...
export async function apiRoutes(fastify: FastifyInstance) {
  ...
  const postmark = fastify.postmark as PostmarkService;

  /**
   * Generate ICS from event data - POST /api/generate-ics
   */
  fastify.post('/api/generate-ics', async (request: FastifyRequest<{ Body: any }>, reply: FastifyReply) => {
    try {
   ...
   */
  fastify.post('/api/extract-events', async (request: FastifyRequest<{ Body: any }>, reply: FastifyReply) => {
    try {
      // Validate request body
   ...
   */
  fastify.post('/api/fetch-url', async (request: FastifyRequest<{ Body: any }>, reply: FastifyReply) => {
    try {
      // Validate request body
   ...
   */
  fastify.post('/api/confirm-events', async (request: FastifyRequest<{ Body: any }>, reply: FastifyReply) => {
    try {
      // Validate request body
   ...
   */
  fastify.post('/api/webhooks/postmark', async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      ...
      await postmark.sendErrorNotification(
