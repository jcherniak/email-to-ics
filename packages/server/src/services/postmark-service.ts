...
export class PostmarkService {
   ...
   */
  async processInboundEmail(webhookData: any): Promise<{
    success: boolean;
  ...
  private buildTextBody(description: string, eventTitle: string, isTentative: boolean): string {
...
Generated by Email-to-ICS
  ...
  private buildHtmlBody(description: string, eventTitle: string, isTentative: boolean): string {
    const status = isTentative ? 'TENTATIVE' : 'CONFIRMED';
